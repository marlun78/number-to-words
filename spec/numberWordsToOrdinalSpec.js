...
var numberWordsToOrdinal = require('../src/numberWordsToOrdinal');

describe('numberWordsToOrdinal', function () {
    var tests = [
        { input: 'zero', expect: 'zero' },
    ...
    function addTest(test) {
        it('should, if passed "' + test.input + '", return "' + test.expect + '"', function () {
            expect(numberWordsToOrdinal(test.input)).toEqual(test.expect);
        });
    }
